...
void main() {
  ...
  setUp(() async {
    ...
    const EventChannel compassChannel = EventChannel(
  ...
  testWidgets(
    'Regression Test: Simulates user walking, updates camera, and visits The Phoenix pub',
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: MapScreen(
            mapProviderBuilder:
                ({
                  required ValueChanged<MapboxMapController>
                  onControllerCreated,
